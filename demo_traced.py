...
if __name__ == "__main__":
    ...
    parser.add_argument("-kp","--kp_detector_path", default='kp_detector.pt', help="path to kp_detector checkpoint")
    parser.add_argument("-gen", "--generator_path", default='generator.pt', help="path to generator checkpoint ")
    ...
    generator, kp_detector = load_checkpoints(opt.kp_detector_path, opt.generator_path, cpu=opt.cpu)
